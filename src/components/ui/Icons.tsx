...
export function PieChartFullIcon(props: IconProps) {
  return (
    <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M11 3.055A9.001 9.001 0 1020.945 13H11V3.055z" />
...
export function ErrorCircleSolidIcon(props: IconProps) {
  return (
    <svg fill="currentColor" viewBox="0 0 20 20" {...props}>
...
export function LockPadlockIcon(props: IconProps) {
  return (
    <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" {...props}>
...
export function SunSolidIcon(props: IconProps) {
  return (
    <svg fill="currentColor" viewBox="0 0 20 20" {...props}>
      <path
        fillRule="evenodd"
...
export function MoonSolidIcon(props: IconProps) {
  return (
    <svg fill="currentColor" viewBox="0 0 20 20" {...props}>
