...
import { Alert, Spinner, CheckCircleIcon, LockPadlockIcon } from '@/components/ui';
...
export const PasswordGateLogin = memo(function PasswordGateLogin({ password, onPasswordChange, error, isLoading, onSubmit }: PasswordGateLoginProps) {
  return (
        ...
        <div className="flex items-center justify-center mb-8">
          <div className="flex items-center gap-3">
            <div className="flex items-center justify-center w-12 h-12 rounded-xl bg-gradient-to-br from-navy-700 to-navy-900 shadow-lg">
              <CheckCircleIcon className="w-6 h-6 text-gold-400" />
            </div>
            <div>
        ...
        <form onSubmit={onSubmit} className="space-y-6">
          ...
          >
            {isLoading ? (
              ...
              <>
                <LockPadlockIcon className="w-5 h-5" />
                Unlock
              </>
            )}
          </button>
